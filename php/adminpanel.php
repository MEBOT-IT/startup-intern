...
if(isset($_POST['update_product'])){
   ...
   image = '$update_p_image' WHERE id = '$update_p_id'");
...
if(isset($message)){
   foreach($message as $message){
      ...
      '</span> <i class="fas fa-times" onclick="this.parentElement.style.display = `none`;">
      </i> </div>';
   };
};
...
<form action="" method="post" class="add-product-form" enctype="multipart/form-data">
   <h3 style="color:green">add a new product</h3>
   ...
   <table>
      ...
      <tbody>
         ...
         <tr>
            ...
            <td>RS.<?php echo $row['price']; ?>/250grms</td>
            <td>
               <a href="adminpanel.php?delete=<?php echo $row['id']; ?>" class="delete-btn" 
