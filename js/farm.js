...
// loopings for anchor tags :home page 
...
// product moouseover and mouseout -product page 

const divs = document.querySelectorAll(".item");
divs.forEach(function(div) {
  div.addEventListener("mouseover", function() {
    div.style.backgroundColor = "yellowgreen"; // green color on mouseover
  });

  div.addEventListener("mouseout", function() {
    div.style.backgroundColor = "initial"; //  original color on mouseout
  });
});
...
// mouseevent green color text changes
function myFunction(){
...
// image change moon and sun(dark and light mode) 
// mouseover and mouseout

function setSunImage()
{
  document.getElementById("darkimg").src="./images/light.png";
}
function setMoonImage()
{
  document.getElementById("darkimg").src="/images/dark.png";
}
